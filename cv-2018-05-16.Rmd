...
PhD Educational Psychology & Educational Technology \hfill 2018 (Expected)  
Graduate Certificate, Science Education \hfill 2017  
MA Educational Technology \hfill 2012  

*University of North Carolina, Asheville*  
BS Biology \hfill 2010  
Teacher Licensure Program \hfill 2010  
...
Rosenberg, J. M., Xu, R., & Frank, K. (2017). konfound: Sensitivity analysis based on Rubin’s causal model [Statistical software for R]. Retrieved from https://github.com/jrosen48/konfound

Rosenberg, J. M., Xu, R., & Frank, K. (2017). konfound: Sensitivity analysis based on Rubin’s causal model [Interactive web application]. Retrieved from https://jmichaelrosenberg.shinyapps.io/shinykonfound/

Rosenberg, J. M., Schmidt, J. A., & Beymer, P. N. (2017). tidyLPA:  Interface to MCLUST to perform Latent Profile Analysis in R. [Statistical software for R]. Retrieved from https://github.com/jrosen48/tidyLPA
